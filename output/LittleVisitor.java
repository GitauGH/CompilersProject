...
public interface LittleVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link LittleParser#else_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElse_stmt(LittleParser.Else_stmtContext ctx);
	/**
	 * Visit a parse tree produced by {@link LittleParser#if_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIf_(LittleParser.If_Context ctx);
	/**
	 * Visit a parse tree produced by {@link LittleParser#else_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElse_(LittleParser.Else_Context ctx);
	/**
	 * Visit a parse tree produced by {@link LittleParser#endif}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEndif(LittleParser.EndifContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LittleParser#while_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWhile_(LittleParser.While_Context ctx);
	/**
	 * Visit a parse tree produced by {@link LittleParser#endwhile}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEndwhile(LittleParser.EndwhileContext ctx);
}